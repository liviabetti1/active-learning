...
def unit_aware_pointwise_cost(s, already_labeled_array, unit_labeled_array, c1=1, c2=5): #unit_labeled_array is binary indicating whether that index point is in an already labeled unit
