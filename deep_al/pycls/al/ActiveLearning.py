...
class ActiveLearning:
    ...
    def sample_from_uSet(self, clf_model, lSet, uSet, trainDataset, supportingModels=None, cost_path=None):
        ...
        elif self.cfg.ACTIVE_LEARNING.SAMPLING_FN == "ensemble_variance":
            activeSet, uSet = self.sampler.ensemble_variance(budgetSize=self.cfg.ACTIVE_LEARNING.BUDGET_SIZE, uSet=uSet, reg_models=supportingModels, dataset=trainDataset)
